      ...
      <main>
        <div className="min-h-screen bg-[#0f0f1a] text-[#f5f0e8] flex flex-col items-center justify-center relative overflow-hidden">
          ...
          >
            ...
            >
              Test your art history knowledge across 700 years of masterworks
              from the world&apos;s great collections.
            </motion.p>

            {/* CTAs — using Link for crawlability */}
            <motion.div
            ...
            >
              <Link
                href="/daily"
                className="inline-flex items-center justify-center min-w-[200px] text-base font-semibold px-6 py-3 rounded-lg bg-gradient-to-r from-[#e08a2c] to-[#c96f1a] hover:from-[#eb9535] hover:to-[#d47a22] text-white shadow-lg shadow-[#e08a2c]/10 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
              >
                Daily Challenge
              </Link>
              <Link
                href="/play"
                className="inline-flex items-center justify-center min-w-[200px] text-base font-semibold px-6 py-3 rounded-lg bg-[#16213e] border border-[#2a2a4e] text-[#f5f0e8] hover:border-[#c9a84c]/40 hover:bg-[#1a2744] transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
              >
                Endless Mode
              </Link>
            </motion.div>
            ...
            >
              <span className="flex items-center gap-1.5">
                <span className="w-1 h-1 rounded-full bg-[#c9a84c]/40" />5
                rounds
              </span>
              <span className="flex items-center gap-1.5">
            ...
            <motion.nav
              ...
              className="mt-6 flex items-center justify-center gap-4 text-[11px] text-[#f5f0e8]/20"
            >
              <Link
                href="/how-to-play"
