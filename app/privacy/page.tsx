...
export const metadata = {
  title: 'Privacy Policy — PaintingGuessr',
};
      ...
      <section className="space-y-6">
        <div>
          ...
          <p>
            ...
            Service&quot;) respects your privacy. This Privacy Policy explains
            what information is collected, how it is used, and your rights
            regarding that information when you use our website.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="font-medium text-[#f5f0e8] mt-3 mb-1">
            a) Information collected automatically
          </p>
          <p>
            When you visit PaintingGuessr, certain information may be collected
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2 space-y-2 text-[#f5f0e8]/70">
            <li>
              <strong className="text-[#f5f0e8]">Google AdSense:</strong>{' '}
              Google uses cookies to serve ads based on your prior visits to
              this website and other websites. Google&apos;s use of advertising
              cookies enables it and its partners to serve ads based on your
              visit to PaintingGuessr and/or other sites on the Internet. You
            ...
            <li>
              <strong className="text-[#f5f0e8]">Vercel Analytics:</strong>{' '}
        ...
        <div>
          ...
          <p>
            ...
            For more information about how Google manages data in its ad
            products, visit the{' '}
            <a
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-[#f5f0e8]/70">
            <li>
              ...
              described in this policy, solely for the purposes outlined above.
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-[#f5f0e8]/70">
            <li>
              <strong className="text-[#f5f0e8]">Opt out of personalized ads:</strong>{' '}
              Visit{' '}
              <a
                href="https://www.google.com/settings/ads"
                className="text-[#c9a84c] hover:underline"
